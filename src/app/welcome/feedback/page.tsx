...
async function fetchWelcomePageData() {
  ...
  if (rows.length === 0) {
    return {
      ...
      introContent: 'Established in 1978, Babulal Premsons Group is a household name in Ranchi, Jharkhand, trusted by generations for premium quality textiles, automobiles, and more.',
      ...
      contactEmail: 'info@babulalpremsons.com',
